...
#define COLOR_BRI_ADJ_RGB(brightness, rgb)                                                                        \
    COLOR_BRI_ADJ_COLOR(brightness, rgb)                                                                          \
    | (COLOR_BRI_ADJ_COLOR(brightness, (rgb >> 8)) << 8) | (COLOR_BRI_ADJ_COLOR(brightness, (rgb >> 16)) << 16) | \
