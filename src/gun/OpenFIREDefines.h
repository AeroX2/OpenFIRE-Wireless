...
#include "OpenFIREversion.h"  // 696969 added to better manage versions
...
// #define DUAL_CORE // 696969 defined in platformio.ini
...
// Leave this uncommented to enable MAMEHOOKER support, or comment out (//) to disable references to serial reading and
// only use it for debugging. WARNING: Has a chance of making the board lock up if TinyUSB hasn't been patched to fix
// serial-related lockups. If you're building this for RP2040, please make sure that you have NOT installed the TinyUSB
// library. If unsure, leave uncommented - serial activity is used for configuration, and undefining this will cause
// errors.
// #define MAMEHOOKER // 696969 defined in platformio.ini

// Leave this uncommented to support use of hardware switches, or comment out to disable all references to hw switch
// functionality.
// #define USES_SWITCHES // 696969 defined in platformio.ini

// Leave this uncommented to support use of rumble motors, or comment out to disable any references to rumble
// functionality.
// #define USES_RUMBLE // 696969 defined in platformio.ini

// Leave this uncommented to support use of solenoids for force feedback, or comment out to disable any references to
// solenoid functionality.
// #define USES_SOLENOID // 696969 defined in platformio.ini
#ifdef USES_SOLENOID
// Leave this uncommented for TMP36 temperature sensor support for solenoid tempering, or comment out to disable
// references to temperature reading or throttling.
// #define USES_TEMP // 696969 defined in platformio.ini
#endif  // USES_SOLENOID

// Leave this uncommented to support use of analog sticks in analog pins.
// #define USES_ANALOG // 696969 defined in platformio.ini

// Leave this uncommented to support use of a four pin RGB LED.
// #define FOURPIN_LED // 696969 defined in platformio.ini
#ifdef FOURPIN_LED
    #define LED_ENABLE
#endif  // FOURPIN_LED

// Leave this uncommented to support use of an external NeoPixel strand.
// #define CUSTOM_NEOPIXEL // 696969 defined in platformio.ini
#ifdef CUSTOM_NEOPIXEL
    #define LED_ENABLE
#endif  // CUSTOM_NEOPIXEL

// Leave this uncommented to enable support for SSD1306 monochrome OLED displays as an I2C peripheral.
// #define USES_DISPLAY // 696969 defined in platformio.ini
