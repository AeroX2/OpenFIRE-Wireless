...
// PauseMode_BurstFireToggle,
    ...
    static inline const char* RunModeLabels[RunMode_Count] = {"Normal", "Averaging", "Averaging2", "Processing"};
    ...
    static inline constexpr uint32_t StateFlagsDtrReset =
        StateFlag_PrintSelectedProfile | StateFlag_PrintPreferences | StateFlag_PrintPreferencesStorage;
};
