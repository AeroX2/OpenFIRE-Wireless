...
// inline AbsMouse5_ AbsMouse5(2); // 696969 removed by me
...
class FW_Common {
   public:
    ...
    /// @param    rebindStrSel
    ///           Flag that determines whether to reset the bindings of the special macros
    ///           playerStartBtn/playerSelectBtn
...
//////////////////////////////////////////////////////////////////////////////////////////
    ...
    static inline bool dockedSaving = false;  // true; // false;  // To block sending test output in docked mode.
    ...
    static inline uint32_t aStickADCLastPos =
        0;  // Analog-to-digital direction mask for digital outputs when settings[OF_Const::analogMode] is > 0
#endif      // USES_ANALOG
...
// function for esp32 to emulate rp2040.fifo behavior for multicore communication
...
extern ESP32FIFO esp32_fifo;  // 8 uint32_t elements like rp2040.fifo
