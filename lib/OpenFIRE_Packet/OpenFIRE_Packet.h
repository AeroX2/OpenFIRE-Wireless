...
|      | |      | |      | |______|__________________________________________# len  of payload bytes (lunghezza del
contenuto del paccchetto/payload sempre minore di START_BYTE) |      | |      |
|______|___________________________________________________Packet ID (0 by default) (non deve però essere mai come Start
byte) |      | |______|____________________________________________________________COBS Overhead byte (sempre minore di
START_BYTE)
